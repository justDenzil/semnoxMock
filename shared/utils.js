...
class Reticle extends THREE.Object3D {
  constructor() {
    ...
    this.loader.load("./assets/bracelet.gltf", (gltf) => {
      this.add(gltf.scene);
    })
...
window.gltfLoader.load("", function(gltf) {
  const flower = gltf.scene.children.find(c => c.name === 'bracelet')
  flower.castShadow = true;
  window.bracelet = gltf.scene;
});
